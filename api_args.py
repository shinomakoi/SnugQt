...
class ApiArgs:
    ...
    def sd12(self, img_gen_args):
        ...
        api_prompt = {
                ...
                "16": {
                    "inputs": {
                    "ckpt_name": img_gen_args["sd12_ckpt"]
                    },
                    "class_type": "CheckpointLoaderSimple"
                },
                "18": {
                    "inputs": {
                    "vae_name": img_gen_args["sd12_vae"]
                    },
    ...
    def sdxl_base(self, img_gen_args):
        ...
        api_prompt = {
                "4": {
                    "inputs": {
                    "ckpt_name": img_gen_args["sdxl_base_ckpt"]
                    },
                    "class_type": "CheckpointLoaderSimple"
                },
                "5": {
                ...
                "51": {
                    "inputs": {
                    "vae_name": img_gen_args["sdxl_vae"]
                    },
                    "class_type": "VAELoader"
                }
                }
    ...
    def sdxl_base_refiner(self, img_gen_args):
        ...
        api_prompt = {
                    ...
                    "12": {
                        "inputs": {
                        "ckpt_name": img_gen_args["sdxl_refiner_ckpt"]
                        },
                        "class_type": "CheckpointLoaderSimple"
                    },
                    "15": {
