...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.promptStyleCombo.setInsertPolicy(QComboBox.InsertAlphabetically)
        ...
        self.txt2imgTab.setGeometry(QRect(0, 0, 262, 645))
        ...
        self.img2imgTab.setGeometry(QRect(0, 0, 262, 645))
        ...
        self.inpaintTab.setGeometry(QRect(0, 0, 262, 645))
        ...
        self.upscaleTab.setGeometry(QRect(0, 0, 262, 645))
        ...
        self.controlnetTab = QWidget()
        self.controlnetTab.setObjectName(u"controlnetTab")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 1140, 877))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.promptStyleCombo.setItemText(11, QCoreApplication.translate("MainWindow", u"Art: Hyperrealism", None))
        self.promptStyleCombo.setItemText(12, QCoreApplication.translate("MainWindow", u"Art: Impressionism", None))
        self.promptStyleCombo.setItemText(13, QCoreApplication.translate("MainWindow", u"Art: Renaissance", None))
        self.promptStyleCombo.setItemText(14, QCoreApplication.translate("MainWindow", u"Art: Steampunk", None))
        self.promptStyleCombo.setItemText(15, QCoreApplication.translate("MainWindow", u"Art: Watercolor", None))
        self.promptStyleCombo.setItemText(16, QCoreApplication.translate("MainWindow", u"Genre: Futuristic", None))
        self.promptStyleCombo.setItemText(17, QCoreApplication.translate("MainWindow", u"Genre: Sci-fi", None))
        self.promptStyleCombo.setItemText(18, QCoreApplication.translate("MainWindow", u"Genre: Vaporwave", None))
...
#if QT_CONFIG(tooltip)
        self.outpaintCheck.setToolTip(QCoreApplication.translate("MainWindow", u"Enalble outpainting", None))
#endif // QT_CONFIG(tooltip)
