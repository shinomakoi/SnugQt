...
class Ui_SettingsDialog(object):
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.loraCheck.setText(QCoreApplication.translate("SettingsDialog", u"Use LoRA", None))
...
#if QT_CONFIG(tooltip)
        self.comfyuiExtraFolderSelect.setToolTip(QCoreApplication.translate("SettingsDialog", u"Select a ComfyUI VAE folder", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.comfyuiExtraFolderValue.setToolTip(QCoreApplication.translate("SettingsDialog", u"Select a ComfyUI VAE folder", None))
#endif // QT_CONFIG(tooltip)
